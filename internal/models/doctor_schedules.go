...
type DoctorSchedules struct {
	...
	DoctorsThroughReservationSchedule  []*Doctor      `json:"doctors_through_reservation_schedule,omitempty" join:"joinType:manyToMany;through:reservation;sourcePrimaryKey:id;sourceForeignKey:schedule_id;targetPrimaryKey:id;targetForeign:schedule_id"`
